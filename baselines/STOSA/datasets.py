...
class SASRecDataset(Dataset):
    ...
    def __init__(self, args, user_seq, test_neg_items=None, data_type='train'):
        ...
        if data_type == 'train':  ## data argumentation
            self.user_seq = self.split_data(user_seq)
        else:
            self.user_seq = user_seq
...
class CHLSDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return torch.tensor(0), torch.LongTensor(seq), torch.tensor(0), torch.tensor(0), torch.LongTensor(answer), 
